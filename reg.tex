...
\item 06/12. Laplace didn't considered specific angular momentum but angular momentum itself. Accretion, enhanced viscosity: from 

\item 10/12. Rotating star: coupling with disk or magnetic field; binaries: coriolis force in convection. Tachocline: dynamical discontinuity between solar envelop/core. Magnetosphere. Magnetic dipole coupling between binaeries: applegate 1992. Unified picture: AGN, Sy1/2, density gradient, dust. 
